...
CONFIG = {
    ...
    'site_description': (
        'editorial guide for harem fantasy and men\'s romance fiction'
    ),
    ...
    'promotion_guidance': (
        ...
        "Pivot Press Publishing owns this site and is affiliated with Adam Lance, Annabelle Hawthorne, "
        "Leon West, Michael Dalton, Neil Bimbeau, Sean Oswald, and other authors in its catalog. "
        ...
        "For Fateforged coverage, preserve the source-supported author and series relationships. "
